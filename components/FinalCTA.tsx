  ...
  return (
    <section className="section relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full animate-aurora"
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          {/* Headline */}
          <h2 className="text-display-3 md:text-display-2 font-bold text-white mb-6">
            Ready to <span className="gradient-text-aurora">lower your bills?</span>
          </h2>

          {/* Description */}
          <p className="text-body-lg text-frost-light mb-10 max-w-xl mx-auto">
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center gap-6 text-sm text-frost-medium">
