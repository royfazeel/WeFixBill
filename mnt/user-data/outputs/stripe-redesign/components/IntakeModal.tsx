...
// Input styles (outside component to prevent recreation)
const getInputStyles = (hasError: boolean) => cn(
  ...
  hasError
    ...
    : 'border-slate-200 hover:border-slate-300 focus:border-stripe-purple focus:ring-stripe-purple/10'
)
...
// Memoized FormField component (outside main component)
        ...
        >
          ...
          >
            ...
            <div className="h-1 bg-slate-100">
              <motion.div
                className="h-full bg-gradient-to-r from-stripe-purple to-stripe-blue"
                initial={{ width: '0%' }}
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              formData.billCategory === cat.id
                                ? 'border-stripe-purple bg-stripe-purple/5 ring-2 ring-stripe-purple/20'
                  ...
                  >
                    ...
                    <label
                      ...
                      className={cn(
                        ...
                        file ? 'border-emerald-300 bg-emerald-50' : 'border-slate-200 hover:border-stripe-purple hover:bg-stripe-purple/5'
                      )}
                    >
                      {file ? (
                  ...
                  >
                    ...
                    <label className="flex items-start gap-3 mb-4 cursor-pointer">
                      <input
                        ...
                        className="mt-1 w-5 h-5 rounded border-slate-300 text-stripe-purple focus:ring-stripe-purple/20"
                      />
                      <span className="text-sm text-slate-600">
                        I authorize Wefixbill to negotiate on my behalf and agree to the{' '}
                        <a href="/terms" className="text-stripe-purple hover:underline">Terms</a> and{' '}
                        <a href="/privacy" className="text-stripe-purple hover:underline">Privacy Policy</a>.
                      </span>
                    </label>
                ...
                {step === 4 && submitSuccess && (
                  ...
                  >
                    ...
                    <div className="inline-block bg-slate-100 px-4 py-2 rounded-lg mb-6">
                      ...
                      <p className="text-stripe-purple font-mono font-bold">{submitSuccess.referenceId}</p>
                    </div>
